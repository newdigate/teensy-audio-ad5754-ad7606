...
XYScopeView scopeViewCV3 = XYScopeView(TFT, audioRecordQueue3, audioRecordQueue4, colors[1], (int16_t)ST7735_BLACK, 64, 64); 
XYScopeView scopeViewCV5 = XYScopeView(TFT, audioRecordQueue5, audioRecordQueue6, colors[2], (int16_t)ST7735_BLACK, 64, 64); 
XYScopeView scopeViewCV7 = XYScopeView(TFT, audioRecordQueue7, audioRecordQueue8, colors[3], (int16_t)ST7735_BLACK, 64, 64); 
XYScopeView scopeViewAudio1 = XYScopeView(TFT, audioRecordQueue9, audioRecordQueue10, colors[4], (int16_t)ST7735_BLACK, 64, 64); 
XYScopeView scopeViewAudio3 = XYScopeView(TFT, audioRecordQueue11, audioRecordQueue12, colors[5], (int16_t)ST7735_BLACK, 64, 64); 
XYScopeView scopeViewAudio5 = XYScopeView(TFT, audioRecordQueue13, audioRecordQueue14, colors[6], (int16_t)ST7735_BLACK, 64, 64); 
...
void setup() {
  ...
  sine9.frequency(AUDIO_SAMPLE_RATE_EXACT/(128.0));
  sine9.amplitude(0.7);
  
  sine10.frequency(AUDIO_SAMPLE_RATE_EXACT/(128.0 * 2));
  sine10.amplitude(0.7);
  
  sine11.frequency(AUDIO_SAMPLE_RATE_EXACT/(128.0 * 4));
  sine11.amplitude(0.7);
  
  sine12.frequency(AUDIO_SAMPLE_RATE_EXACT/(128.0 * 6));
  sine12.amplitude(0.7);
  
  sine13.frequency(AUDIO_SAMPLE_RATE_EXACT/(128.0 * 8));
  sine13.amplitude(0.7);
  
  sine14.frequency(AUDIO_SAMPLE_RATE_EXACT/(128.0 * 10));
  sine14.amplitude(0.7);
  
  sine15.frequency(AUDIO_SAMPLE_RATE_EXACT/(128.0 * 0.5));
  sine15.amplitude(0.7);
  
  sine16.frequency(AUDIO_SAMPLE_RATE_EXACT/(128.0 * 0.25));
...
void loop() {
  ...
  if (audioRecordQueue1.available() > 4) {
      audioRecordQueue1.end();
      while (audioRecordQueue1.available() > 4) {
  ...
  if (audioRecordQueue2.available() > 4) {
      audioRecordQueue2.end();
      while (audioRecordQueue2.available() > 4) {
  ...
  if (audioRecordQueue3.available() > 4) {
      audioRecordQueue3.end();
      while (audioRecordQueue3.available() > 4) {
  ...
  if (audioRecordQueue4.available() > 4) {
      audioRecordQueue4.end();
      while (audioRecordQueue4.available() > 4) {
  ...
  if (audioRecordQueue5.available() > 4) {
      audioRecordQueue5.end();
      while (audioRecordQueue5.available() > 4) {
  ...
  if (audioRecordQueue6.available() > 4) {
      audioRecordQueue6.end();
      while (audioRecordQueue6.available() > 4) {
  ...
  if (audioRecordQueue7.available() > 4) {
      audioRecordQueue7.end();
      while (audioRecordQueue7.available() > 4) {
  ...
  if (audioRecordQueue8.available() > 4) {
      audioRecordQueue8.end();
      while (audioRecordQueue8.available() > 4) {
  ...
  if (audioRecordQueue9.available() > 4) {
      audioRecordQueue9.end();
      while (audioRecordQueue9.available() > 4) {
  ...
  if (audioRecordQueue10.available() > 4) {
      audioRecordQueue10.end();
      while (audioRecordQueue10.available() > 4) {
  ...
  if (audioRecordQueue11.available() > 4) {
      audioRecordQueue11.end();
      while (audioRecordQueue11.available() > 4) {
  ...
  if (audioRecordQueue12.available() > 4) {
      audioRecordQueue12.end();
      while (audioRecordQueue12.available() > 4) {
  ...
  if (audioRecordQueue13.available() > 4) {
      audioRecordQueue13.end();
      while (audioRecordQueue13.available() > 4) {
  ...
  if (audioRecordQueue14.available() > 4) {
