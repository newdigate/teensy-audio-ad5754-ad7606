...
void myControlChange(byte channel, byte control, byte value) {
    ...
    if (control == 7) {
        double newValue = value/127.0f;
        switch (channel) {
          case 1: sine1.amplitude(newValue); break;
          case 2: sine2.amplitude(newValue); break;
          case 3: sine3.amplitude(newValue); break;
          case 4: sine4.amplitude(newValue); break;
          case 5: sine5.amplitude(newValue); break;
          case 6: sine6.amplitude(newValue); break;
          case 7: sine7.amplitude(newValue); break;
          case 8: sine8.amplitude(newValue); break;
        }
    } else if (control >= 48 && control <= 55) {
        double newValue = value/127.0f;
        switch (control) {
          case 48: sine9.amplitude(newValue); break;
          case 49: sine10.amplitude(newValue); break;
          case 50: sine11.amplitude(newValue); break;
          case 51: sine12.amplitude(newValue); break;
          case 52: sine13.amplitude(newValue); break;
          case 53: sine14.amplitude(newValue); break;
          case 54: sine15.amplitude(newValue); break;
          case 55: sine16.amplitude(newValue); break;
        }
    } else if (control >= 16 && control <= 23) {
        double newValue = value/127.0f;
        if (channel == 9) {
          switch (control) {
            case 16: freq_coarse[9] = value; sine9.frequency(getFrequency(9)); break;
            case 17: freq_coarse[10] = value; sine10.frequency(getFrequency(10)); break;
            case 18: freq_coarse[11] = value; sine11.frequency(getFrequency(11)); break;
            case 19: freq_coarse[12] = value; sine12.frequency(getFrequency(12)); break;
            case 20: freq_coarse[13] = value; sine13.frequency(getFrequency(13)); break;
            case 21: freq_coarse[14] = value; sine14.frequency(getFrequency(14)); break;
            case 22: freq_coarse[15] = value; sine15.frequency(getFrequency(15)); break;
            case 23: freq_coarse[16] = value; sine16.frequency(getFrequency(16)); break;
          }
        }
    }
